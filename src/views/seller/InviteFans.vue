<template>
  ...
  <img
    style="display:none"
    src="https://qrmkt.oss-cn-beijing.aliyuncs.com/hbseller_client/invite-fans-qrcode.png"
    alt=""
  />
  <img
    style="display:none"
    src="https://qrmkt.oss-cn-beijing.aliyuncs.com/hbseller_client/icon-back.png"
    alt=""
  />
    ...
    .qrcode-bar {
      ...
      .qrcode-icon {
        .bg-img(
          14px,
          14px,
          'https://qrmkt.oss-cn-beijing.aliyuncs.com/hbseller_client/invite-fans-qrcode.png'
        );
      }
      .text {
        font-size: 14px;
